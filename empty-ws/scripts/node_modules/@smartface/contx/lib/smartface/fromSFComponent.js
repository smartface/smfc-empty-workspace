...
function addChild(superAddChild, child, name, classNames = "", userProps = null, defaultClassNames = "") {
  superAddChild(child);
  name && this.dispatch((0, _addChild.default)(name, child, classNames, userProps, defaultClassNames));
}
...
function createTreeItem(component, name, rootName, root, defaultClassNames) {
  ...
  return {
    component,
    classNames,
    defaultClassNames: componentVars.defaultClassNames ? componentVars.defaultClassNames + (defaultClassNames ? " " + defaultClassNames : "") : defaultClassNames,
...
function createActorTreeFromSFComponent(component, name, rootName, defaultClassNames) {
  if (component.addChild || component.layout) {
    ...
    return {
      [createName(rootName, name)]: (0, _Stylable.default)(createTreeItem(component, name, rootName, component, defaultClassNames))
    };
  }
}